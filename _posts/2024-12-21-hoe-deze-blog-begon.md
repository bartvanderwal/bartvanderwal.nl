...
*Deze blogpost is geschreven met behulp van [Claude Code CLI](https://claude.ai/claude-code). De broncode van deze site is te vinden op [GitHub](https://github.com/bartvanderwal/bartvanderwal.nl) (zolang de repo publiek staat - zodra mijn GitHub academic license weer actief is gaat het weer op privé).*
