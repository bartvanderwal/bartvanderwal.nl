...
2. **Ankerlink naar bronnenlijst**: De referentie linkt naar de bijbehorende bron in je eigen bronnenlijst: [Fowler (2014)](#bronnen). De lezer blijft in je document.

3. **Directe link naar bron**: De referentie linkt direct naar de externe bron: [Fowler (2014)](https://martinfowler.com/articles/microservices.html). Handig, maar de lezer kan afdwalen.
